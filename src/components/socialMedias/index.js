    ...
    <div className={classes[props.background]}>
      <div className={classes.AppContainer}>
        <ScrollAnimation animateIn="fadeIn" animateOnce={true} duration={2}>
          ...
          <br />
          <a
            href="https://www.linkedin.com/in/photographerluizlima/"
            target="_blank"
          >
          ...
          <a href="https://www.facebook.com/luiz.lima.750" target="_blank">
            <span className={classes.facebook}>
              <FaFacebookSquare size={50} />
            </span>
          </a>
          <a href="https://www.instagram.com/luizlima750/" target="_blank">
